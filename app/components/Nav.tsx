    ...
    <header style={{ borderBottom: '1px solid var(--line)' }}>
      ...
      <div style={{ maxWidth: 1080, margin: '0 auto', padding: '1.2rem 1.25rem .9rem', display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: '1rem' }}>
        <Link href="/" style={{ textDecoration: 'none' }}>
          ...
          <div style={{ marginTop: '.25rem', fontSize: '.52rem', letterSpacing: '.13em', textTransform: 'uppercase', color: 'var(--ink-muted)' }}>
        ...
        <button
          ...
          style={{
            ...
            color: 'var(--ink)', fontFamily: 'inherit', fontSize: '.56rem',
            letterSpacing: '.1em', textTransform: 'uppercase', padding: '.36rem .75rem',
        ...
        {tabs.map(t => (
          <Link
            ...
            style={{
              ...
              fontFamily: 'inherit', fontSize: '.57rem', letterSpacing: '.13em',
